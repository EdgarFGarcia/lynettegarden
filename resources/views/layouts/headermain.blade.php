<html>
<head>
<title>Lynette Gardens Website</title>
<link rel="stylesheet" href="{{ asset('css/style.css') }}">
<link rel="stylesheet" href="{{ asset('css/birthday.css') }}">
<link rel="stylesheet" href="{{ asset('css/contact.css') }}">
<link rel="stylesheet" href="{{ asset('css/eventportfolio.css') }}">
...
<link rel="stylesheet" href="{{ asset('css/reservation2.css') }}">
<link rel="stylesheet" href="{{ asset('css/social.css') }}">
<link rel="stylesheet" href="{{ asset('css/viewpayment.css') }}">
