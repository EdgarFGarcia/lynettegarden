    ...
    <div id="headerSlider" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{ asset('assets/img/lynette/forest.jpg') }}"class="d-block w-100" alt="...">
                <div class="carousel-caption">
                    <h5>Our Business is Making Memory Unforgettable</h5>
                    <a href="#portfolio" class="btn btn-light">MAKE A RESERVATION</a>
                </div>
            </div>
            <div class="carousel-item">
                <img src="{{ asset('assets/img/lynette/greengrass.jpg') }}" class="d-block w-100" alt="...">
                <div class="carousel-caption">
            ...
            <div class="carousel-item">
                <img src="{{ asset('assets/img/lynette/sunnyforest.png') }}" class="d-block w-100" alt="...">
                <div class="carousel-caption">
...
<section id="reservation">
    <div class="container">
        ...
        <div class="col-md-12">
            <label>Make Your Reservation Less Hassle</label>
        </div>
        <div class="col-md-12">
            <a href="#portfolio" class="btn btn-warning">BOOK NOW</a>
        </div>
...
<section id="location">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <img src="{{ asset('assets/img/lynette/location.png') }}" height="350px"/>
            </div>     
        </div>
    </div>
</section>
